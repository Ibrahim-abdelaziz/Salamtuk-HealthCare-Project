...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('doctors_app', '0009_auto_20190902_2241'),
    ]
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.CharField(choices=[('saturday', 'saturday'), ('sunday', 'sunday'), ('monday', 'monday'), ('tuseday', 'tuseday'), ('wensday', 'wensday'), ('thursday', 'thursday'), ('friday', 'friday')], max_length=250, verbose_name='select to'),
        ),
        migrations.AlterField(
            model_name='doctor',
            name='Specialized',
